   ...
   <div id="list-cart">
      ...
      <form>
         <table class="table table-bordered .table-responsive text-center">
            ...
            <tr>
               <td><img class="img-responsive" src="../upload/image/{{$item->options->img}}"></td>
               <td>{{$item->name}}</td>
               <td>
                  <div class="form-group">
                     <input class="form-control" type="number" onchange="updateCate(this.value,'{{ $item->rowId }}')" value="{{$item->qty}}">
                  </div>
               </td>
